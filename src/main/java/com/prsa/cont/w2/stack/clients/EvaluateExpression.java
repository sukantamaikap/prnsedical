...
public class EvaluateExpression {
  ...
  /**
   * Assumption : the passed expression is well formed and there is a space between any number or
   * expression.
   *
   * @param expression
   * @return
  ...
  private static void calculateAndPushBack(
      ArrayStack<Long> numbers, ArrayStack<String> operations) {
