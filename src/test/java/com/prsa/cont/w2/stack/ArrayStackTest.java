...
public class ArrayStackTest {
  ...
  public void testIntStack() {
    ...
    for (int j = 0; j < capacity; j++) {
      ...
      assertTrue(
          poppedItem == expectedOutput,
          "Item was not inserted properly, expected : "
              + expectedOutput
              + " but found : "
              + poppedItem);
    }
  ...
  public void testStackResizing() {
    ...
    assertTrue(
        integerStack.getCapacity() == 1,
        "expected capacity is 2 when all items are popped, found : " + integerStack.getCapacity());
  ...
  public void testStackIterator() {
    ...
    for (int i : integerStack) {
      ...
      assertTrue(
          i == expectedOutput,
          "Item was not inserted properly, expected : " + expectedOutput + " but found : " + i);
      count++;
    }
