...
/**
 * Write a program to find the intersection between two lists of Strings. Do this with and without
 * an optimized data structure and quantify the time difference as the input sizes of the two lists
 * grow to bigger numbers.
 *
 * <p>public ArrayList<String> getCommonWords(ArrayList<String> list1, ArrayList<String> list2){ }
 */
