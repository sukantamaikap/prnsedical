...
public class CommonStackProblemsTest {
  ...
  public void testIsParenthesesBalancedEmptyExpression() {
    ...
    Assert.assertFalse(
        stackProblems.isParenthesesBalanced(""),
        "Empty string as input should give invalid expression!!");
  }
  ...
  public void testIsParenthesesBalancedNullExpression() {
    final CommonStackProblems stackProblems = new CommonStackProblems();
    Assert.assertFalse(
        stackProblems.isParenthesesBalanced(null),
        "Null as input should give invalid expression!!");
  }
  ...
  public void testIsParenthesesBalancedInvalidExpression() {
    ...
    Assert.assertFalse(
        stackProblems.isParenthesesBalanced("[{(}]()"),
        "Incomplete expression as input should give invalid expression!!");
  }
  ...
  public void testIsParenthesesBalancedValidExpression() {
    ...
    Assert.assertTrue(
        stackProblems.isParenthesesBalanced("[{}]()"),
        "Complete expression as input should give valid expression!!");
  }
}
