...
public class BinarySearchTreeTest {
  ...
  public void testGet() throws Exception {
    ...
    Assert.assertTrue(
        testSearchTree.get(102).equals("One Hundred and Two"), "Maximum key not found");
  }
  ...
  public void testGetMin() throws Exception {
    ...
    Assert.assertTrue(
        testSearchTree.getMin() == null, "Tree is empty, so no minimum value should be found");

    testSearchTree.put(3, "Three");
    Assert.assertEquals(
        testSearchTree.getKey(testSearchTree.getMin()),
        new Integer(3),
        "Minimum key not found for tree with one node!!");
    testSearchTree.put(9, "Nine");
    testSearchTree.put(1, "One");
    testSearchTree.put(-20, "Minus Twenty");
    testSearchTree.put(102, "One Hundred and Two");
  ...
  public void testGetMax() throws Exception {
    ...
    Assert.assertTrue(
        testSearchTree.getMax() == null, "Tree is empty, so no maximum value should be found");

    testSearchTree.put(3, "Three");
    Assert.assertEquals(
        testSearchTree.getKey(testSearchTree.getMax()),
        new Integer(3),
        "Maximum key not found for tree with one node!!");
    testSearchTree.put(9, "Nine");
    testSearchTree.put(1, "One");
    testSearchTree.put(-20, "Minus Twenty");
    testSearchTree.put(102, "One Hundred and Two");
  ...
  public void testGetSize() throws Exception {
    final BinarySearchTree<Integer, String> testSearchTree = new BinarySearchTree<>();
    Assert.assertEquals(
        testSearchTree.getSize(), 0, "Size should be zero for a tree with no nodes !!");

    testSearchTree.put(1, "1");
    Assert.assertEquals(
        testSearchTree.getSize(), 1, "Size should be one for a tree with one nodes !!");

    testSearchTree.put(2, "2");
    Assert.assertEquals(
        testSearchTree.getSize(), 2, "Size should be two for a tree with two nodes !!");
    ...
    Assert.assertEquals(
        testSearchTree.getSize(), 6, "Size should be six for a tree with six nodes !!");
  ...
  public void testKeys() throws Exception {
    final BinarySearchTree<Integer, String> testSearchTree = new BinarySearchTree<>();
    Assert.assertEquals(
        this.getIteratorSize(testSearchTree.keys()),
        0,
        "There should be no items as no item has been inserted !!!");
    ...
    Assert.assertEquals(
        this.getIteratorSize(testSearchTree.keys()), 10, "Key size does not match !!");
  }
  ...
  public void testKeysWithRange() throws Exception {
    ...
    Assert.assertEquals(
        this.getIteratorSize(testSearchTree.keys(8, 10)), 3, "Key size does not match !!");
    Assert.assertEquals(
        this.getIteratorSize(testSearchTree.keys(199, 999)), 0, "Key size does not match !!");
    Assert.assertEquals(
        this.getIteratorSize(testSearchTree.keys(-199, -32)), 0, "Key size does not match !!");
  }
  ...
  public void testDeleteMin() throws Exception {
    ...
    testSearchTree.deleteMin();
    Assert.assertEquals(
        testSearchTree.getSize(),
        0,
        "For a tree with just root node, deleteMin should delete the root node !!!");
  ...
  public void testDeleteMax() throws Exception {
    ...
    Assert.assertEquals(
        testSearchTree.getSize(),
        0,
        "For a tree with just root node, deleteMax should delete the root node !!!");
  ...
  public void testDelete() throws Exception {
    ...
    Assert.assertEquals(
        testSearchTree.getSize(), 10, "delete should not alter size for not present key !!");
