...
public class CommonArrayProblemsTest {
  ...
  public void testFindMinimumDistanceBetweenTwoElements() throws Exception {
    ...
    Assert.assertEquals(
        arrayProblems.findMinimumDistanceBetweenTwoElements(input, 2, 3),
        1,
        "Expected minimum distance does not match!!");
    input = new int[] {9, 1, 1, 12, 9, 1, 1, 1, 9};
    Assert.assertEquals(
        arrayProblems.findMinimumDistanceBetweenTwoElements(input, 1, 9),
        1,
        "Expected minimum distance does not match!!");
  }
  ...
  public void testMergeOverlappingIntervals() throws Exception {
    ...
    Assert.assertEquals(
        arrayProblems.mergeOverlappingIntervals(input),
        output,
        "Expected minimum distance does not match!!");
  ...
  public void findPairSumInArray() throws Exception {
    ...
    int sum = 6;
    Assert.assertEquals(
        arrayProblems.findPairSumInArray(sum, input),
        Arrays.asList(-6, 12, 2, 4),
        "The output does not match !!!");
    input = new int[] {200, 42, 84, -923, 66, 12, -82, -97, 99};
    sum = 2;
    Assert.assertEquals(
        arrayProblems.findPairSumInArray(sum, input),
        Arrays.asList(-97, 99, -82, 84),
        "The output does not match !!!");
    Assert.assertEquals(
        arrayProblems.findPairSumInArray(sum, null),
        Arrays.asList(),
        "The output does not match !!!");
    input = new int[] {2, 4};
    sum = 2;
  ...
  public void findMostFrequentElementWithNull() {
    ...
    Assert.assertNull(
        arrayProblems.findMostFrequent(input), "For null input, output must be null !!!");
  }
  ...
  public void findMostFrequentElementWithTwoElementArray() {
    ...
    Assert.assertNull(
        arrayProblems.findMostFrequent(input),
        "Should return null, as the input contains just 2 elements!!");
  }
  ...
  public void findMostFrequentElementWithUniqueElementArray() {
    ...
    Assert.assertNull(
        arrayProblems.findMostFrequent(input), "Should return null, as all are unique elements");
  }
  ...
  public void findMostFrequentElementWithDuplicateElementsInArray() {
    ...
    Assert.assertEquals(
        arrayProblems.findMostFrequent(input),
        Integer.valueOf(10),
        "Most frequent element must be 10");
  }
  ...
  public void findIntersectionWithFirstInputNull() {
    ...
    final CommonArrayProblems arrayProblems = new CommonArrayProblems();
    Assert.assertNull(
        arrayProblems.findIntersection(input1, input2),
        "for either of the inputs being null or empty, the output must be null!!");
  }
  ...
  public void findIntersectionWithTwoInputsOfSameSize() {
    ...
    final CommonArrayProblems arrayProblems = new CommonArrayProblems();
    Assert.assertEquals(
        arrayProblems.findIntersection(input1, input2), output, "Expected output does not match");
  }
  ...
  public void testTwoArraysAreRotationOfOneAnotherWithNullInput() {
    ...
    final CommonArrayProblems arrayProblems = new CommonArrayProblems();
    Assert.assertFalse(
        arrayProblems.isRotation(input1, input2),
        "For null or empty inputs, it should not be considered a rotation !!");
  }
  ...
  public void testTwoArraysAreRotationOfOneAnotherWithOneElementArray() {
    ...
    Assert.assertTrue(
        arrayProblems.isRotation(input1, input2),
        "For 1 element array with identical element, the response should be true!!");
  }
  ...
  public void testTwoArraysAreRotationOfOneAnotherWithOneElementUniqueArray() {
    ...
    Assert.assertFalse(
        arrayProblems.isRotation(input1, input2),
        "For 1 element inputs with non-identical element, the response should be False!!");
  }
  ...
  public void testTwoArraysAreRotationOfOneAnotherWithArraysOfDifferentSize() {
    ...
    Assert.assertFalse(
        arrayProblems.isRotation(input1, input2),
        "For input of different size, the output should be false !!");
  }
  ...
  public void testTwoArraysAreRotationOfOneAnotherWithValidInputOfSizeTwo() {
    ...
    final CommonArrayProblems arrayProblems = new CommonArrayProblems();
    Assert.assertTrue(
        arrayProblems.isRotation(input1, input2), "For valid input, the outcome should be True !!");
  }
  ...
  public void testTwoArraysAreRotationOfOneAnotherWithIdenticalInput() {
    ...
    Assert.assertFalse(
        arrayProblems.isRotation(input1, input2),
        "For identical input, the outcome should be True !!");
  }

  @Test
  public void testRangeQueryForFrequencyInAnArray() {
    int[] input = null;
    final CommonArrayProblems arrayProblems = new CommonArrayProblems();
    Assert.assertTrue(
        arrayProblems.rangeQueryForFrequencyInAnArray(3, 8, input, 8) == -1,
        "For null or empty input, the range should be -1");
    input = new int[0];
    Assert.assertTrue(
        arrayProblems.rangeQueryForFrequencyInAnArray(3, 8, input, 8) == -1,
        "For null or empty input, the range should be -1");
    int[] validInput = {2, 8, 4, 5, 8, 7, 6, 9, 100, 2, 8, 88, 23, 46, 91, 8, 6, 7, 213, 819};
    Assert.assertTrue(
        arrayProblems.rangeQueryForFrequencyInAnArray(4, 20, validInput, 9999) == 0,
        "For number not being a member of the array, the frequency should be 0");
    Assert.assertTrue(
        arrayProblems.rangeQueryForFrequencyInAnArray(4, 901, validInput, 213) == -1,
        "For invalid range, the output should be -1");
    Assert.assertTrue(
        arrayProblems.rangeQueryForFrequencyInAnArray(1024, 901, validInput, 213) == -1,
        "For invalid range, the output should be -1");
    Assert.assertTrue(
