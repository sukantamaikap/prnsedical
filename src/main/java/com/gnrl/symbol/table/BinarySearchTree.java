...
public class BinarySearchTree<Key extends Comparable<Key>, Value> {
  ...
  /**
   * Get minimum value from the Tree. Given the principle, go left till the leftNode is null
   *
  ...
  private Node delete(Node node, final Key key) {
    ...
    // match found
      ...
      // delete the min of the right subtree and link the root of right subtree to the replaced
      // node's right
